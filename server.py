...
def reconstructor(sent_token, selected_ckp_filtered, selected_sent_index):
    ...
    selected_ckp_filtered, = [string1, string2, ...]
    ...
    res_dict = {
        "og_sents" : [],
        "selected_ckp_filtered" : selected_ckp_filtered,
        "selected_full_sents" : [],
        "zip_display" : []
    }
    ...
    res_dict["zip_display"] = list(zip(res_dict["selected_ckp_filtered"], res_dict["selected_full_sents"]))
...
def embed_rank_pipline(pdf_filename):
    ...
    selected_ckp_strings, selected_ckp_filtered, selected_sent_index = er.mmr(doc_embed, ckps_embed)

    return reconstructor(sent_token, selected_ckp_filtered, selected_sent_index)
